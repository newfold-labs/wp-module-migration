...
class MigrationModal {
	...
	update(title = '', description = '') {
		...
		description = '' === description ? migration.migration_description : description;
		document.querySelector('.nfd-migration-title').innerText = title;
		document.querySelector('.nfd-migration-description').innerHTML = description;
	}
	show(withClose = false) {
		if (withClose) {
